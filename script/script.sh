...
mysql -h testvmss.mysql.database.azure.com -u testvmss@testvmss -pubuntuVm2018 -e "CREATE DATABASE wordpress; GRANT ALL PRIVILEGES ON wordpress.* TO 'testvmss'@'testvmss' IDENTIFIED BY 'ubuntuVm2018';"
