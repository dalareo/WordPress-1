...
sudo bash -c 'echo '//$2.file.core.windows.net/wp-content' /var/www/html/wp-content cifs nofail,vers=3.0,credentials=/etc/smbcredentials/storageaccountname.cred,dir_mode=0777,uid=www-data,gid=www-data,file_mode=0777,serverino >> /etc/fstab'
